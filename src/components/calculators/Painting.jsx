...
import { Settings, Calculator, PlusCircle, Trash2, Box, Info, AlertCircle, Paintbrush, Eye, EyeOff, ArrowUp, Copy } from 'lucide-react';
                        ...
                        <div className="flex flex-col md:flex-row justify-between md:items-start mb-8 gap-6">
                            <div>
                                ...
                                <div className="flex flex-wrap gap-4 mt-3">
                                    <p className="text-sm text-gray-500">Total Surface Area: <strong className="text-gray-900">{result.totalArea.toFixed(2)} m²</strong></p>
                                </div>
                            </div>
                            <div className="flex flex-col items-end gap-3">
                                ...
                                <div className="flex gap-2">
                                    <ExportButtons items={result.items} filename="painting_estimate.csv" />
                                </div>
                            </div>
                        </div>
