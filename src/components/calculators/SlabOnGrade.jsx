...
import { Settings, Calculator, PlusCircle, Trash2, AlertCircle, Eye, EyeOff, ArrowUp, Copy, Box } from 'lucide-react';
                        ...
                        <div className="flex flex-col md:flex-row justify-between md:items-start mb-8 gap-6">
                            ...
                            <div className="flex flex-col items-end gap-3">
                                ...
                                <div className="flex gap-2">
                                    <ExportButtons items={result.items} filename="slab_estimate.csv" />
                                </div>
                            </div>
                        </div>
