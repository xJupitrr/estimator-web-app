...
import { Settings, Calculator, PlusCircle, Trash2, Box, Info, AlertCircle, Layout, Eye, EyeOff, ArrowUp, Copy, MoveHorizontal } from 'lucide-react';
                        ...
                        <div className="flex flex-col md:flex-row justify-between md:items-start mb-8 gap-6">
                            <div>
                                ...
                                <div className="flex flex-wrap gap-4 mt-3">
                                    <p className="text-sm text-gray-500">Total Drywall Area: <strong className="text-gray-900">{result.totalArea.toFixed(2)} m²</strong></p>
                                </div>
                            </div>
